...
main_questions = {1: ["Ухаживать за животными",
             ...
             "2) Преобразовательный  - направлен на преоброзование энергии, информации, предметы, процессы. Примеры: растениевод, учитель, бухгалтер." + '\n'
             "3) Изыскательские - напрален на создание чего-либо нового. Примеры: программист, инженер, биолог-исследователь, дизайнер."
             }
